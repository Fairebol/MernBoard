...
export default function Aside() {
    return (
        <section className="sticky left-0 top-0 w-1/4 h-screen bg-slate-800 border-r-[1px] border-slate-700 overflow-y-auto overflow-x-hidden custom-scroll hidden md:block">
